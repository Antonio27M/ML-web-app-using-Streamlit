...
val6 = st.slider('citric acid', min_value=0.00000, max_value=1.00000, step=0.1)
val7 = st.slider('chlorides', min_value=0.01200, max_value=0.61100, step=0.1)
...
val10 = st.slider('density', min_value=0.99007, max_value=1.00369, step=0.1)
val11 = st.slider('sulphates', min_value=0.33000, max_value=2.00000, step=0.1)


if st.button("Predict"):
    prediction = str(model.predict([[val1, val2, val3, val4, val5, val6, val7, val8, val9, val10, val12]])[0])
